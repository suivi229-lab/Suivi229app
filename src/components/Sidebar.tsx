...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`no-print fixed left-0 top-0 h-full z-40 flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transition-all duration-300 ${
